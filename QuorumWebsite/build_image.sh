...
docker buildx build --no-cache -f Dockerfile.quorum-database-server.build -t andreasstefik/quorum-database-server:2.5.2 . --platform linux/amd64,linux/arm64 --push
