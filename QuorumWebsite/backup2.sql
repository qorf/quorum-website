...
--
-- Host: localhost    Database: stefika_sodbeans_users
-- ------------------------------------------------------
...
--
-- Dumping data for table `compiled_files`
--

LOCK TABLES `compiled_files` WRITE;
/*!40000 ALTER TABLE `compiled_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `compiled_files` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `password_reset_addresses`
--

LOCK TABLES `password_reset_addresses` WRITE;
/*!40000 ALTER TABLE `password_reset_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_reset_addresses` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `password_reset_keys` WRITE;
/*!40000 ALTER TABLE `password_reset_keys` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_reset_keys` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `quorum_studio_downloads`
--

LOCK TABLES `quorum_studio_downloads` WRITE;
/*!40000 ALTER TABLE `quorum_studio_downloads` DISABLE KEYS */;
/*!40000 ALTER TABLE `quorum_studio_downloads` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-18 18:21:46
